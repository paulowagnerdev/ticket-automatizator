...
import LoadingCicleComponent from "../../hooks/LoadingCircle/LoadingCircleComponent.jsx"
...
function AddUser({ functionClosePopUp }) {
  ...
  const [msgErrorOnSubmitCpfInput, setMsgErrorOnSubmitCpfInput] =
    useState(false);
  const [msgErrorOnSubmitNameInput, setMsgErrorOnSubmitNameInput] =
    useState(false);
  const [msgErrorOnSubmitLastnameInput, setMsgErrorOnSubmitLastnameInput] =
    useState(false);
  const [textInformationSendingEmail, setTexttInformationSendingEmail] =
    useState("iniciando processo de envio...");
  const [showLoadingSendingEmail, setShowLoadingSendingEmail] = useState(false);
  const [statusLoadingSendingEmail, setStatusLoadingSendingEmail] =
    useState("");
    ...
    <div className="div-add-user-popup">
      ...
      <form>
        ...
        <CpfComponent
          ...
          functionHandleSetCpf={(e) =>
            setFinalPersonDataValues((prev) => ({ ...prev, cpf: e }))
          }
        />
